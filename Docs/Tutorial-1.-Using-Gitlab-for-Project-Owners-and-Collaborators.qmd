...
NOTE: if we _fork_ a repository instead of cloning it, this will create a completely independent copy of the Git repository. Here, we need _cloning_ so that our local changes can be synchronized and we don't create duplicates of the repository.
