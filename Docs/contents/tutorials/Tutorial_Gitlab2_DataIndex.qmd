---
title: Gitlab Tutorial 2. Create and Update a Data Index
subtitle: A workflow to use Gitlab pages as an open data Index
...
3.  **Scripts to render** an HTML landing site, i.e. the Data Index, which provides access for collaborators. This can be done without web development skill using in R markdown or R Quarto markdown.
