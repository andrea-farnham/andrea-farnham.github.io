...
Short descriptions and references for some technical terms and software used in our tutorials
...
#### Static websites 
By static we mean that the user will just see whatever data is contained in the HTML that compose the website. Anyone landing in that website will see the same content, no new content is generated based on the user's input. 
